...
1. Explain the difference between Relational Databases and SQL.
   relational databases are just the consept of using multiple tables that all relate to eachother. SQL is what we use to make that happen
2. Why do tables need a Primary Key?
   to keep track of and reference a specific entry
